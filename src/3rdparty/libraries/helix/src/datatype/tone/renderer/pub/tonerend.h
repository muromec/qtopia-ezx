...
class CAudioFormat;
class CTONEAudioFormat;


class CTONEAudioRenderer : public CAudioRenderer,
                          public CHXBaseCountingObject
{
public:
    CTONEAudioRenderer(void);
    virtual ~CTONEAudioRenderer();
