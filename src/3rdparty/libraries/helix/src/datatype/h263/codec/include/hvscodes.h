/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hvscodes.h,v 1.3 2007/07/06 22:00:32 jfinnecy Exp $
 * 
 ...
 *
 *  NAME  
 *    HVSCODES -- code symbols for streams.
 *
 *  SYNOPSIS
 *    #include "hvscodes.h"
 *     ...
 *
 *  DESCRIPTION:
 *    This file holds the constants used throughout this project.
...
#define VVS_LAYOUT_YUV12   (VVS_CODE_BASE + 17)
