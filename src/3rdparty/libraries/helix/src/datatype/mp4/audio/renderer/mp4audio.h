...
#ifndef __MP4AUDIO_H__
#define __MP4AUDIO_H__
 ...
 *  CMP4AudioRenderer
 */
class CMP4AudioRenderer : public CAudioRenderer,
...
protected:
    CAudioFormat* CreateFormatObject(IHXValues* pHeader);
