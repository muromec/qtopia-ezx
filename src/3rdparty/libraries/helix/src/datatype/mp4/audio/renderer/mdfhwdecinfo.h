...
#ifndef MDFHWDECINFO_H
#define MDFHWDECINFO_H 
...
class CMDFHWDecInfo : public CDecoderInfo
{
public:

    CMDFHWDecInfo(CMP4ADecoder* decoder);
...
private:
    ...
    CDecoderInfo*   m_pDecInfo;
    CRAACDecInfo    m_RAACDecInfo;
