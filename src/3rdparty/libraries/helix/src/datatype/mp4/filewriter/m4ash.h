...
class CM4AStreamHandler : public IMP4StreamHandler
{
public:
    CM4AStreamHandler( IUnknown* pContext, IMP4StreamMixer* pMixer );
    ~CM4AStreamHandler();
...
private:
    ...
    HX_RESULT GetASCFromESD( IHXBuffer* pESD, UINT8*& pASC, UINT32& ulASCLength );
