 ...
 *  QcelpPayloadFormat
 */
class CQCELPPayloadFormat : public IMP4APayloadFormat
{
public:
    CQCELPPayloadFormat();
    ~CQCELPPayloadFormat();
     ...
     */
    virtual ULONG32 GetBitstreamHeaderSize(void)   { return m_ulBitstreamHdrSize; }
...
private:
    ...
    UINT8*                 m_bitstreamHdr;
    ULONG32                m_ulBitstreamHdrSize;
    ULONG32                m_ulSampleRate;
    ULONG32                m_ulAUDuration;
    QcelpDepack            m_depack;
