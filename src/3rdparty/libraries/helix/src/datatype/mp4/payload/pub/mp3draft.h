...
class CMP3DraftPayloadFormat : public IMP4APayloadFormat
{
public:
    CMP3DraftPayloadFormat();
    virtual ~CMP3DraftPayloadFormat();
...
protected:
    INT32      m_lRefCount;
    IHXPacket* m_pCurPacket;
    UINT32     m_ulHeaderSize;
    BYTE*      m_pHeader;
    UINT32     m_ulSampleRate;
    HXBOOL       m_bClearMainDataBegin;
};

#endif  /* #ifndef MP3DRAFT_H */
