/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: tsmoothtime_main.cpp,v 1.2 2007/07/06 20:39:30 jfinnecy Exp $
 * 
...
{
    return new HLXCommandDispatchTest<HLXCommandParser>(CHXTimeSyncSmootherTest());
}
