/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: test_velocity_caps_main.cpp,v 1.2 2007/07/06 20:39:29 jfinnecy Exp $
 * 
...
{
    return new HLXCommandDispatchTest<HLXCommandParser>(CHXPlaybackVelocityCapsTest());
}
