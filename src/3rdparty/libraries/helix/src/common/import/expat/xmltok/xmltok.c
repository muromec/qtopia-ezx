...
{
  int i;
  struct unknown_encoding *e = (struct unknown_encoding*) mem; /* Helix expat change */
...
{
    static const char * const encodingNames[] = { /* Helix expat change */
    KW_ISO_8859_1,
    KW_US_ASCII,
    KW_UTF_8,
    KW_UTF_16,
  ...
  for (i = 0; i < (int)(sizeof(encodingNames)/sizeof(encodingNames[0])); i++)
    if (streqci(name, (const char*) encodingNames[i])) /* Helix expat change */
      return i;
  return UNKNOWN_ENC;
}
