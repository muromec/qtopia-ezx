/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: chxmapstringtostring.h,v 1.10 2007/07/06 20:35:02 jfinnecy Exp $
 * 
...
public:
    ...
    HXBOOL Lookup(key_arg_type key, CHXString& value) const;
...
HXBOOL CHXMapStringToString::IsEmpty() const
{
    return GetCount() == 0;
}
