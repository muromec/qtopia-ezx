/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: hxposixsockutil.h,v 1.5 2007/07/06 20:43:59 jfinnecy Exp $ 
 *   
...
//
// helpers for working with posix/bsd socket api in conjunction with API defined in hxnet.h
//
...
struct HXPosixSockUtil // namespace
{
    ...
    static HX_RESULT CreateAddrInfo(IHXNetServices* pNetServices, 
                         const struct hostent* phe, UINT16 port,
                         CHXSimpleList& list /*modified*/);

    static HX_RESULT CreateAddrInfo(IHXNetServices* pNetServices, 
                         const struct addrinfo* pai,
                         CHXSimpleList& list /*modified*/);
    static HX_RESULT GetSockAddr(IHXSockAddr* pAddr, sockaddr_storage& sa);
