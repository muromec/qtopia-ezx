/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: win_fwctlmgr.h,v 1.6 2007/07/06 20:44:00 jfinnecy Exp $
 * 
...
public:
    ...
    STDMETHOD_(HXBOOL,IsFirewallOn)   (THIS);
    ...
    STDMETHOD_(HXBOOL, IsAppExempted) (const char* pszAppPath);
