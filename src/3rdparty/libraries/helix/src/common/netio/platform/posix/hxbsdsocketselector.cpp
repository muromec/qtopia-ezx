/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: hxbsdsocketselector.cpp,v 1.3 2006/02/17 01:47:06 ping Exp $ 
 *   
...
{
    // XXXLCM see unix_net::add_select(); similar logic needed
    HX_ASSERT(false);
    return HXSocketSelector::UpdateSocket(fd, eventMask);
}
