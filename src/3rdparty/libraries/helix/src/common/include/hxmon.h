/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxmon.h,v 1.9 2007/07/06 20:43:42 jfinnecy Exp $
 * 
...
#include "hxcomptr.h"
DEFINE_SMART_PTR(IHXRegistry)
DEFINE_SMART_PTR(IHXPropWatch)
DEFINE_SMART_PTR(IHXPropWatchResponse)
DEFINE_SMART_PTR(IHXActiveRegistry)
DEFINE_SMART_PTR(IHXActivePropUser)
DEFINE_SMART_PTR(IHXActivePropUserResponse)
DEFINE_SMART_PTR(IHXCopyRegistry)
DEFINE_SMART_PTR(IHXRegistryAltStringHandling)
DEFINE_SMART_PTR(IHXRegistry2)
DEFINE_SMART_PTR(IHXDeletedPropResponse)
