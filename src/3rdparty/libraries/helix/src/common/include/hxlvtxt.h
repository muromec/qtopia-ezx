/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxlvtxt.h,v 1.4 2005/03/14 19:27:09 bobclark Exp $
 * 
...
DECLARE_INTERFACE_(IHXLiveText, IUnknown)
{
     ...
     */
    STDMETHOD_(HXBOOL,EncoderIsInitialized)   (THIS) PURE;
    STDMETHOD_(HXBOOL,PacketsHaveStarted)	    (THIS) PURE;
    STDMETHOD_(HXBOOL,EncoderIsDone)	    (THIS) PURE;
...
DECLARE_INTERFACE_(IHXLiveText2, IUnknown)
{
    ...
    STDMETHOD(IgnoreExtraSpaces)	(THIS_
					HXBOOL bIgnoreExtraSpaces) PURE;
