/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxlvpix.h,v 1.4 2005/03/14 19:27:09 bobclark Exp $
 * 
...
typedef struct HXEXPORT_CLASS _PixInitInfo
{
    ...
    HXBOOL    m_bPreserveAspect;      /* preserve aspect ratio by default? */
...
typedef struct HXEXPORT_CLASS _PixEffectInfo
{
    ...
    HXBOOL    m_bAspectFlag;         /* Input:  TRUE: preserve aspect on this effect; FALSE: don't preserve */
    ...
    HXBOOL    m_bDiscardImage;       /* Input:  TRUE: discard image after doing effect; FALSE: don't discard */
    HXBOOL    m_bDisplayImmediately; /* Input:  FALSE: obey start time; TRUE: do effect immediately */
