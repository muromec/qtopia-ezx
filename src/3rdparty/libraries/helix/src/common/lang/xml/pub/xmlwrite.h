/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: xmlwrite.h,v 1.4 2007/07/06 20:43:47 jfinnecy Exp $
 * 
...
// $Id: xmlwrite.h,v 1.4 2007/07/06 20:43:47 jfinnecy Exp $
...
public:
    ...
    XMLWriterTag *CreateTag(const char *name = NULL);
    HXBOOL Write(IHXBuffer *buffer, INT32& loc);
    void Clear(void);
