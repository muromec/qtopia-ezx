/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxdatasource_factory.cpp,v 1.3 2007/07/06 20:35:15 jfinnecy Exp $
...
IHXMMFDataSource* CHXDataSourceFactory::Build(CHXMediaSource& aMediaSource, HXBOOL bPeek)
{
    ...
    case CHXMediaSource::EDescriptor:
        pDataSource = CHXDataSourceDescriptor::Create((TDesC8*)aMediaSource.m_pData, bPeek);
        break;
...
#else
    case CHXMediaSource::ECMMFClip:
        pDataSource = new CHXDataSourceMMFClip((CMMFClip *)aMediaSource.m_pData);
        break;
#endif
