/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: symbihxdataf.h,v 1.9 2007/07/06 20:35:15 jfinnecy Exp $
 * 
...
public:
	 ...
	 *  Constructor
	 */
	CSymbIHXDataFile(IUnknown* pContext, IUnknown** ppCommonObj = NULL);
	...
	HXBOOL GetTemporaryFileName	(const char *tag, char* filename, UINT32 ulBufLen);
