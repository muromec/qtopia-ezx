/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: mmapdatf.h,v 1.6 2007/07/06 20:35:17 jfinnecy Exp $
 * 
...
public:
					MemoryMapDataFile(IUnknown* pContext,
					    ...
					    HXBOOL bDisableMemoryMappedIO = FALSE,
					    UINT32 ulChunkSize = 0,
					    HXBOOL bEnableFileLocking = FALSE);
					~MemoryMapDataFile();
    /*
     *  IUnknown methods
     */
