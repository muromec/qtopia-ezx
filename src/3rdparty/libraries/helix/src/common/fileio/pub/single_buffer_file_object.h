...
#ifndef SINGLE_BUFFER_FILE_OBJECT_H
#define SINGLE_BUFFER_FILE_OBJECT_H

// Includes
#include "hxfiles.h"
#include "baseobj.h"

class CHXSingleBufferFileObject : public IHXFileObject,
                                  public IHXFileStat,
...
public:
    ...
    STDMETHOD(Init)        (THIS_ ULONG32 ulFlags, IHXFileResponse* pFileResponse);
...
#endif /* #ifndef SINGLE_BUFFER_FILE_OBJECT_H */
