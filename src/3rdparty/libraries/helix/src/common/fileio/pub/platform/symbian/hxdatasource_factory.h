/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxdatasource_factory.h,v 1.3 2007/07/06 20:35:21 jfinnecy Exp $
...
#ifndef _HX_DATASOURCE_FACTORY_H_
#define _HX_DATASOURCE_FACTORY_H_
