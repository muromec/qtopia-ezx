/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxdatasource_ccontent.h,v 1.4 2007/07/06 20:35:21 jfinnecy Exp $
...
#ifndef _HX_DATASOURCE_CCONTENT_H_
#define _HX_DATASOURCE_CCONTENT_H_
...
class CHXDataSourceCContent : public CHXDataSource
{
...
private:
    ...
    void ConstructL(char* pFileName);
    void ConstructL(RFile *pFileHandle);
...
#endif // _HX_DATASOURCE_CCONTENT_H_
