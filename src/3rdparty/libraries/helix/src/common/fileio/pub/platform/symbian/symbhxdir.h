/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: symbhxdir.h,v 1.7 2007/07/06 20:35:21 jfinnecy Exp $
 * 
...
{
public:
    CHXDirectory(IUnknown* pContext = NULL, IUnknown** ppCommonObj = NULL);
    ~CHXDirectory();
    ...
    virtual HXBOOL IsWritable();

protected:
    HXBOOL IsValidFileDirName(const char* szPath);
    HXBOOL IsWritable(const char* szPath);
...
private:
    ...
    HXBOOL GetFileAttributes(const char* szPath, TUint& symbAttValue);
