/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: cihx2chxdataf.h,v 1.7 2007/07/06 20:35:11 jfinnecy Exp $
 * 
...
public:
	 ...
	 *  Constructor
	 */
	CIHX2CHXDataFile(IUnknown* pContext, UINT32 ulFlags = 0, IUnknown** ppCommonObj = NULL);
