/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: testclnteng.h,v 1.2 2007/07/06 20:51:39 jfinnecy Exp $
 * 
...
#ifndef TESTCLNTENG_H
#define TESTCLNTENG_H

#include "hxtypes.h"
#include "hxcom.h"
#include "hxcore.h"

class CHXSDPTestClientEngine : public IHXClientEngine
{
public:
    CHXSDPTestClientEngine();
