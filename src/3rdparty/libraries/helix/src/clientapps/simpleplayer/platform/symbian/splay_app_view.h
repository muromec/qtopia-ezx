...
#ifndef SPLAY_APP_VIEW_H
#define SPLAY_APP_VIEW_H
...
class CHXSplayAppView : public CAknView
{
public:    
    static CHXSplayAppView* NewL(const TRect& aRect);
    CHXSplayAppView();
    virtual ~CHXSplayAppView();
    void ConstructL();
    ...
    CHXSplayContainer* GetContainer();
...
private:
    ...
    CHXSplayContainer* m_pContainer;
};

#endif /* SPLAY_APP_VIEW_H */
