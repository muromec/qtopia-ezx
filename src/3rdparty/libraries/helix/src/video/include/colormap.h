/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: colormap.h,v 1.5 2008/08/22 07:48:58 hychoi Exp $
 * 
...
/* Get a Bitmap pitch with CID and biWidth
 * Use:
 *  int GetBitmapPitch2 (int CID, int biWidth);
 * Returns:
 *  the Pitch value, if found
 *  else 0 (unknown), 768 (XING).
 */
int GetBitmapPitch2 (int cid, int biWidth);
