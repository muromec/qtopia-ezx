/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: rgb444torgb444.c,v 1.6 2007/07/06 20:53:52 jfinnecy Exp $
 * 
...
void
RGB444toRGB444_ROW_SHRINK (unsigned char *dest_ptr,
...
void
RGB444toRGB444_ROW_COPY (unsigned char *dest_ptr, int dest_dx,
                        unsigned char *src_ptr, int src_dx)
{
    ...
    while (count >= 4)
    {
        ...
        *(unsigned short *) (d) = da_rgb;
        ...
        sa_rgb = *(unsigned short *) (s + 2);
        da_rgb = sa_rgb;
        *(unsigned short *) (d + 2) = da_rgb;

        sa_rgb = *(unsigned short *) (s + 4);
        da_rgb = sa_rgb;
        *(unsigned short *) (d + 2 * 2) = da_rgb;

        sa_rgb = *(unsigned short *) (s + 6);
        da_rgb = sa_rgb;
...
void
RGB444toRGB444_ROW_STRETCH (unsigned char *dest_ptr, int dest_dx,
                           unsigned char *src_ptr, int src_dx)
{
    register unsigned char *d = dest_ptr;
    register unsigned char *s = src_ptr;
...
void
RGB444toRGB444_ROW_STRETCH2X (unsigned char *dest_ptr, int dest_dx,
                             unsigned char *src_ptr, int src_dx)
{
    register unsigned char *d = dest_ptr;
    register unsigned char *s = src_ptr;
...
void
RGB444toRGB444_ROW_STRETCH2XPLUS (unsigned char *dest_ptr, int dest_dx,
                                 unsigned char *src_ptr, int src_dx)
{
    register unsigned char *d = dest_ptr;
    register unsigned char *s = src_ptr;
...
void
RGB444toRGB444_ROW2X_SHRINK (unsigned char *dest_ptr_1,
...
void
RGB444toRGB444_ROW2X_COPY (unsigned char *dest_ptr_1,
                          unsigned char *dest_ptr_12,
                          unsigned char *dest_ptr_2, int dest_dx,
                          unsigned char *src_ptr, int src_dx)
{
...
void
RGB444toRGB444_ROW2X_STRETCH (unsigned char *dest_ptr_1,
                             unsigned char *dest_ptr_12,
                             unsigned char *dest_ptr_2, int dest_dx,
                             unsigned char *src_ptr, int src_dx)
{
...
void
RGB444toRGB444_ROW2X_STRETCH2X (unsigned char *dest_ptr_1,
                               unsigned char *dest_ptr_12,
                               unsigned char *dest_ptr_2, int dest_dx,
                               unsigned char *src_ptr, int src_dx)
{
...
void
RGB444toRGB444_ROW2X_STRETCH2XPLUS (unsigned char *dest_ptr_1,
                                   unsigned char *dest_ptr_12,
...
int
RGBtoRGB4 (int dest_format, unsigned char *dest_ptr, int dest_width,
          ...
          int src_dx, int src_dy)
{
    ...
    void (*RowFuncs[5]) (unsigned char *dest_ptr, int dest_dx,
                         unsigned char *src_ptr, int src_dx) =
        {
            RGB444toRGB444_ROW_SHRINK,
            RGB444toRGB444_ROW_COPY,
            RGB444toRGB444_ROW_STRETCH,
            RGB444toRGB444_ROW_STRETCH2X,
            RGB444toRGB444_ROW_STRETCH2XPLUS
        };
    ...
    void (*Row2xFuncs[5]) (unsigned char *dest_ptr_1, unsigned char *dest_ptr_12,
                           ...
                           unsigned char *src_ptr, int src_dx) =
        {
            RGB444toRGB444_ROW2X_SHRINK,
            RGB444toRGB444_ROW2X_COPY,
            RGB444toRGB444_ROW2X_STRETCH,
            RGB444toRGB444_ROW2X_STRETCH2X,
            RGB444toRGB444_ROW2X_STRETCH2XPLUS
        };
    ...
    if (((unsigned) dest_ptr & 3) || (dest_pitch & 1) ||
        ((unsigned) src_ptr & 3) || (src_pitch & 1) ||
...
int
RGB444toRGB444 (unsigned char *dest_ptr,
               ...
               color_data_t * not_used)
{
    ...
    const int src_format = 18;	/* RGB444 */
    return RGBtoRGB4 (dest_format, dest_ptr, dest_width, dest_height, dest_pitch,
