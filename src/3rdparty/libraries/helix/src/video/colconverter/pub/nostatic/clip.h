/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: clip.h,v 1.4 2007/07/06 20:53:53 jfinnecy Exp $
 * 
...
#define CLIP_EXTERN  /**/
#endif
CLIP_EXTERN unsigned char clip[MAX_CLIP_BITS-MIN_CLIP_BITS+1][CLIPNEG+CLIPRNG+CLIPPOS];
