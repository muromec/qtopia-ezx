/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxcolor.cpp,v 1.3 2005/03/11 19:58:04 bobclark Exp $
 * 
...
#include "hxtypes.h"
#include "hxcom.h"
#include "platform/openwave/hxcolor.h"
...
/// Because ADS1.2 armcpp crash bug, we will not using these function on Openwave platform.
#ifndef ADS12
/*
 ...
 */
HXBOOL HXEXPORT ENTRYPOINT(ScanAllCompatibleColorFormats) (HXBOOL (*pfnTryIt) (void *pParam, INT32 cidOut, LPHXCOLORCONVERTER pfnCC)
