/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: audhpux.h,v 1.6 2007/07/06 20:21:19 jfinnecy Exp $
 * 
...
class CAudioOutHPUX : public CAudioOutUNIX
{
  public:
    CAudioOutHPUX();
    virtual ~CAudioOutHPUX();
  ...
  private:
    ...
    CAudioOutHPUX( const CAudioOutHPUX& );  //Not implemented.

    ULONG32 m_ulLastBytesPlayed;
