/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: mimetpref.h,v 1.2 2003/01/23 23:42:53 damonlan Exp $ 
 *   
...
class MimeTypesPrefController : public PrefController
{
public:
    MimeTypesPrefController(Process* p);
    ~MimeTypesPrefController();
