/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: hdprefctrl.h,v 1.2 2003/01/23 23:42:53 damonlan Exp $ 
 *   
...
class HTTPDeliverablePrefController : public PrefController
{
public:
    HTTPDeliverablePrefController(Process*, char* pCharListName, char*** HTTP_paths);
    ~HTTPDeliverablePrefController();
