/* ***** BEGIN LICENSE BLOCK *****  
 * Source last modified: $Id: source_container.h,v 1.4 2004/05/03 19:02:48 tmarshall Exp $ 
 *   
...
class SourceContainer : public IHXRawSourceObject,
			public IHXPSinkPackets
{
public:
    SourceContainer(IUnknown* pContext, IHXPSourceControl* pSource);
