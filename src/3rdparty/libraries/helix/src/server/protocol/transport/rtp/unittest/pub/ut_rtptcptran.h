/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: ut_rtptcptran.h,v 1.3 2006/10/12 22:46:11 tknox Exp $
 *
...
#ifndef UT_RTP_TCP_TRANSPORT_H
#define UT_RTP_TCP_TRANSPORT_H
...
class CUTServerRTPTCPTransportTestDriver : public CppUnit::TestFixture
{
public:

    CUTServerRTPTCPTransportTestDriver ();
    virtual ~CUTServerRTPTCPTransportTestDriver ();

    virtual void setUp ();
    virtual void tearDown ();

    CPPUNIT_TEST_SUITE( CUTServerRTPTCPTransportTestDriver );
    CPPUNIT_TEST( testWritePacketNULLBuffer );
    CPPUNIT_TEST( testWritePacketEmptyBuffer );
    CPPUNIT_TEST( testWritePacketTooFullBuffer );
    CPPUNIT_TEST( testWritePacketJustRightBufferNonBlocking );
    CPPUNIT_TEST( testWritePacketJustRightBufferBlocking );
    ...
    void testWritePacketJustRightBufferNonBlocking ();
    void testWritePacketJustRightBufferBlocking ();
...
private:
    ...
    SPServerRTPTCPTransport         m_spTransport;
