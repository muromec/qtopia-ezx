/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxnetwksvcpln.h,v 1.2 2007/07/06 21:58:23 jfinnecy Exp $
 * 
...
#ifndef _HXNETWKSVCPLN_H_
#define _HXNETWKSVCPLN_H_

#include "unkimp.h"
#include "hxplugn.h"
#include "baseobj.h"

class CHXNetworkServicePlugin : public IHXPlugin
...
protected:
    ...
    virtual ~CHXNetworkServicePlugin();

public:
    CHXNetworkServicePlugin();
