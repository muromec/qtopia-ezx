/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: rlogplin.h,v 1.6 2007/07/06 21:58:25 jfinnecy Exp $
 * 
...
private:
    ...
    HXRemoteLogger* m_pRemoteLogger;
};
