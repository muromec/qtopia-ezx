/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxnetif.h,v 1.5 2005/03/14 20:28:53 bobclark Exp $
 * 
...
private:
    ...
    HX_RESULT	    RetrieveNetInterface(CHXSimpleList*& pNetInterfaceList);
    HXBOOL	    IsNetInterfaceChanged(void);
...
public:
    ...
    STDMETHOD(GetNetInterface)			(THIS_
						UINT16		lIndex,
						REF(NIInfo*)	pNIInfo);
