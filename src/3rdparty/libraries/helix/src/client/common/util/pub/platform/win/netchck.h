/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: netchck.h,v 1.3 2005/03/14 20:28:56 bobclark Exp $
 * 
...
public:
	...
	virtual HXBOOL FInternetAvailable(HXBOOL fPing = FALSE, HXBOOL fProxy = FALSE);
...
protected:
	...
	HXBOOL FNetCardActive();	
	HXBOOL DevNodeIsActive(const char *szDeviceID);
	HX_RESULT WinInetGetConnected(HXBOOL& bConnected);
