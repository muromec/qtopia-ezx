/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: validatr.cpp,v 1.16 2007/10/12 00:45:21 ping Exp $
 * 
...
HXValidator::BuildProtocolList(void)
{
    ...
    // temporary hack to add HTTP for Nimbus till we implement
    // GetPluginInfo in BaseHandler
    pProtocol = new CHXString("http");
    m_ProtocolList.AddTail(pProtocol);
#endif /* HELIX_FEATURE_NIMBUS */
