/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: hxmedengpln.h,v 1.5 2007/07/06 21:58:16 jfinnecy Exp $
 * 
...
#ifndef _HXMEDENGPLN_H_
#define _HXMEDENGPLN_H_
...
class CHXMediaPlaybackEngine : public IHXPlugin
...
protected:
    ...
    virtual ~CHXMediaPlaybackEngine();

public:
    CHXMediaPlaybackEngine();
