/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: pfeventproxy.h,v 1.2 2007/07/06 21:58:11 jfinnecy Exp $
 * 
...
#ifndef PFEVENTPROXY_H
#define PFEVENTPROXY_H
...
class CPresentationFeatureEventProxy : public IHXEventSink
{
  public:
    CPresentationFeatureEventProxy(IHXPresentationFeatureSink* pPresentationFeatureSink,
    ...
    IHXPresentationFeatureSink* GetSink() { return m_pPresentationFeatureSink; }

  protected:
    INT32                           m_lRefCount;
    IHXPresentationFeatureSink*     m_pPresentationFeatureSink;
    IHXPresentationFeatureManager*  m_pPresentationFeatureManager;

  private:
    CPresentationFeatureEventProxy() {};
};

#endif /* #ifdef PFEVENTPROXY_H */

#endif /* #if defined(HELIX_FEATURE_PRESENTATION_FEATURE_SELECTION) */
