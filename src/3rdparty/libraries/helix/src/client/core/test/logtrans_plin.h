/* ***** BEGIN LICENSE BLOCK *****
 * Source last modified: $Id: logtrans_plin.h,v 1.3 2007/07/06 21:58:17 jfinnecy Exp $
 * 
 ...
 * 
 * ***** END LICENSE BLOCK ***** */
#ifndef _LOGTRANS_PLIN_H_
#define _LOGTRANS_PLIN_H_
...
class CHXLogTranslatorPlugin : public IHXPlugin,
                               public IHXGenericPlugin,
                               public IHXPlayerCreationSink
{
public:
    CHXLogTranslatorPlugin();
    ~CHXLogTranslatorPlugin();
