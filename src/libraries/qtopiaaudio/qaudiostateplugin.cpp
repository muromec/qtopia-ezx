...
/*!
  ...
  \brief The QAudioStatePlugin class provides a way of managing the underlying audio system, see also: QAudioStateManager

  This class needs to be implemented as part of the Device Profile see also: \l{Device Supplied Bluetooth Audio State Plugin}
